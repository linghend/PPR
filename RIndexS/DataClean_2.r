...
DataClean=function(Data,CBSAID,Ptype)
{	
  FData=Data
  ...
  Quarters=(tempY2-tempY1)*4+(tempQ2-tempQ1)+1
  ...
  FData=FData[,c("PropertyID","AskingRate","QuarterOff","BldgClass","ST","Quarters","ListAge","FloorAbbreviation","AvgSqft","Latitude","Longitude","QuarterOn")]
  names(FData)[8]<-"Floor"
